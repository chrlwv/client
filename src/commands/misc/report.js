...
module.exports = class Report extends Command {
	...
	async exec(message, args, data) {
		...
		if (report !== null && timeout - (Date.now() - report) > 0) {
            ...
            const webhookClient = new WebhookClient({ id: '900345596131565568', token: 'hTHmf_hJJPE6iaATkrfLGUVOgcvqMqa3T2jJzr76xFyvJzxyMtrzBEGO0HfJ1rznKdgb' });
			...
			message.reply(
				`Successfully sent the report. Thanks for your feedback!`
			);
		}
	}
};
